...
#[cfg(feature = "sqlite")]
impl FromSql for TargetId {
    fn column_result(value: rusqlite::types::ValueRef) -> rusqlite::types::FromSqlResult<Self> {
        let id = value.as_i64()?;
        let id = id
            .try_into()
            .map_err(|_| rusqlite::types::FromSqlError::OutOfRange(id))?;
        Ok(TargetId { id, info: None })
    }
}

#[cfg(feature = "sqlite")]
impl ToSql for TargetId {
