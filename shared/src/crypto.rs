...
mod test {
    ...
    fn cross_tree_vector() {
        ...
        let expected = if ENCRYPT {
            hex_to_bytes("0001020304050607dd1f81206467f5574787b94f62e38daf61024021a12672ce6bc39fc8f055513e")
        } else {
            hex_to_bytes("000102030405060708090a0b0c0d0e0f1011121314151617f244c6f1264f3efc21c51522decf3493")
        };
